...
enum MANIFEST {
  ...
  CLOSE_FILE_FAIL,
  REPLAY_FAIL,
  TABLE_CONTAIN_NONEXIST_SSTABLE,
  REMOVE_FILE_FAIL,
  CRC_CHECK_FAIL,
  SEEK_FILE_FAIL,
};
...
enum RC {
  ...
  MANIFEST_REPLAY_FAIL = (MANIFEST_ERROR | (MANIFEST::REPLAY_FAIL) << 8),
  MANIFEST_TABLE_CONTAIN_NONEXIST_SSTABLE = (MANIFEST_ERROR | (MANIFEST::TABLE_CONTAIN_NONEXIST_SSTABLE) << 8),
  MANIFEST_REMOVE_FILE_FAIL = (MANIFEST_ERROR | (MANIFEST::REMOVE_FILE_FAIL) << 8),
  MANIFEST_CRC_CHECK_FAIL = (MANIFEST_ERROR | (MANIFEST::CRC_CHECK_FAIL) << 8),
  MANIFEST_SEEK_FILE_FAIL = (MANIFEST_ERROR | (MANIFEST::SEEK_FILE_FAIL) << 8),
